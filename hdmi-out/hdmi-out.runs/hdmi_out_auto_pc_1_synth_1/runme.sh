...
HD_PWD='C:/Users/suhai/Desktop/3-ugersHardware/hdmi-out/hdmi-out.runs/hdmi_out_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_out_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_out_auto_pc_1.tcl
