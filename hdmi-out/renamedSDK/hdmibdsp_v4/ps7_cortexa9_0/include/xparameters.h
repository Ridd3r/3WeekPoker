...
#define XPAR_AXI_GPIO_HDMI_DEVICE_ID 2
...
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_HDMI_DEVICE_ID
...
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXI_GPIO_LED_DEVICE_ID
...
#define XPAR_FABRIC_GPIO_2_VEC_ID XPAR_FABRIC_AXI_GPIO_HDMI_IP2INTC_IRPT_INTR
